      ...
      <View style={[container.container, container.marginHorizontal]}>
        <View style={{ justifyContent: 'center', flex: 1 }}>
          <View style={{ flex: 1, marginTop:50 }}>
            ...
            {/* </View> */}
            <Button Text='Sign In' viewStyle={{marginTop:15}} onPress={()=>{this.props.navigation.navigate('Home')}}/>
            <View style={{flexDirection:'row',justifyContent:'center',marginTop:30}}>
            <Text Text="Don't have an account? " extraTextStyle={{alignSelf:'center',fontSize:14}}/>
            <TouchableOpacity onPress={()=>{this.props.navigation.navigate('SignUp')}}>
            <Text Text="Sign up" extraTextStyle={{fontSize:14,color:Color.blue,fontFamily: 'OS_SB'}}/>
            </TouchableOpacity>
            </View>
          </View>
        </View>
